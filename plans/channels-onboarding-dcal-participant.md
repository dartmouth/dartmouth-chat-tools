...
Welcome to the Channels pilot! You are part of the second cohort testing Channels, a new real-time messaging feature built directly into Dartmouth Chat.
...
| **Direct message** | Profile photo | Anyone | Just the selected participants |
...
### Find Channels
Open the **left sidebar** in Dartmouth Chat. You will see a **Channels** section. Click it to expand the list. You should already see **#dcal-pilot**, which was created for this pilot.
...
So you do not miss messages from the other pilot member, turn on browser notifications:
...
**Example:**
> @GPT-OSS 120b, We're redesigning the assessment strategy for an introductory biology course. Suggest 3 formative assessment techniques that work well in large lectures and explain why each supports student learning.
...
### Example: Researching Pedagogy in a Channel Thread

1. Create a Workspace Model called "Claude + Web Search"
   - Base Model: Claude Sonnet 4.6
   - Tools: ✅ Web Search
2. In a channel thread, @mention it:
   > @Claude + Web Search, What does recent research say about the effectiveness of specifications grading in undergraduate STEM courses? Include links to key studies or summaries.
...
1. **Use Channels for real conversations** — sharing ideas, discussing course designs, brainstorming with AI
...
5. **Note anything confusing, broken, or missing** — post it in the pinned "Feedback & Friction" thread in #dcal-pilot, or reach out to us directly anytime
...
Reach out anytime during the pilot. You can also post questions directly in **#dcal-pilot**.
